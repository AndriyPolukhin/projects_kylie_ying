def madlib():
    ...
    madlib = f"I love computer programming because it's {ajd1}!The journey to becoming a\
good programmer starts with hope in your mind and a dream in your {body_part}.Through blood,\
sweeat, and {noun_plural_1}, hopefully it never ends.Yes, once you learn to {verb}, it becomes\
...
from developing {ajd3} software to analyzing data and making predictinos about the {noun2}.You can\
